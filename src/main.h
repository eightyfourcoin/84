...
static const int64 MAX_MONEY = 84 * COIN; // 84: maximum of 84 coins
inline bool MoneyRange(int64 nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
static const int COINBASE_MATURITY = 84;
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 2880 / 250; // 84: 720 blocks found a day. Priority cutoff is 1 42 day / 250 bytes.
    }
