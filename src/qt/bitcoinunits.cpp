...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("84");
    case mBTC: return QString("m84");
    case uBTC: return QString::fromUtf8("μ84");
...
QString BitcoinUnits::description(int unit)
{
    ...
    {
    case BTC: return QString("84");
    case mBTC: return QString("Milli-84 (1 / 1,000)");
    case uBTC: return QString("Micro-84 (1 / 1,000,000)");
